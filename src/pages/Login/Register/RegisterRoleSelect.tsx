// src/pages/Auth/Register/RegisterRoleSelect.tsx
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0b0218] via-[#28094a] to-[#100017] text-white px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        >
          ...
          <h2 className="text-xl font-semibold mb-1">Profissional</h2>
          <p className="text-sm text-gray-300 text-center">
            Terapeutas, fonoaudiólogos, terapeutas ocupacionais e clínicos
          </p>
        </motion.button>
        ...
        >
          ...
          <h2 className="text-xl font-semibold mb-1">Pacientes</h2>
          <p className="text-sm text-gray-300 text-center">
