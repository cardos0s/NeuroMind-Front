...
export default function LoginProfessional() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // futuramente: chamar API -> /auth/login-professional
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#100017] text-white px-4">
      ...
      >
        <h1 className="text-2xl font-bold mb-2">Login do profissional</h1>
        <p className="text-sm text-gray-300 mb-4">
          Acesse sua conta profissional para acompanhar pacientes no NeuroMind.
        </p>
